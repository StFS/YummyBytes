...
import static stfs.yummybytes.ByteSizeStandard.IEC;
import static stfs.yummybytes.ByteSizeStandard.SI;
        ...
        for (ByteSizeUnit unit : ByteSizeUnit.values()) {
            ...
            if (unit.prefix.length() == 0) {
                ...
                if (unit.standard == IEC) {
                    ...
                    throw new RuntimeException("broken ByteSizeUnit enum");
                }
            }
        }
        return map;
